...
params.vision_model_name = "M-CLIP/LABSE-Vit-L-14"
...
# device = torch.set_default_device('meta') 
...
class SarcasmModel(nn.Module):
    def __init__(self, params):
        ...
        self.text_model = pt_multilingual_clip.MultilingualCLIP.from_pretrained(params.text_model_name)
        self.text_tokenizer = transformers.AutoTokenizer.from_pretrained(params.text_model_name)
        self.vision_model = clip.load("VIT-L/14", device = device)
    ...
    def forward(self, input_ids, attention_mask, pixel_values, labels=None):
        ...
        text_outputs = self.text_model.forward(input_ids, self.tokenizer)
